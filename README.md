...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/Ketan-cmd/Easy-Expense.git
   cd Easy-Expense
   ```
...
- **[GitHub Repository](https://github.com/Ketan-cmd/Easy-Expense)** - Source code
...
**Built with ❤️ by [Ketan Pathade](https://github.com/Ketan-cmd)**
